...
const PreviewPanel = ({ settings, previewMode, setPreviewMode }) => {
  const defaultInitialMessage = "👋 Want to chat about Hubly? I'm an chatbot here to help you find your way.";
    ...
    <div className="preview-panel">
      ...
      <div className={`chatbot-preview-container ${previewMode}`}>
        <div className="preview-section">
          <h3 className="preview-section-title">Chat Window</h3>
        ...
        <div className="preview-section">
          <h3 className="preview-section-title">Initial Popup</h3>
          <div className="chat-popup-preview">
            <div className="chat-popup-content">
              <button className="close-popup">×</button>
              <div className="chat-popup-avatar"></div>
              <p className="chat-popup-message">
                {settings.initialMessage || defaultInitialMessage}
              </p>
            </div>
          </div>
        </div>
